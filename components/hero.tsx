        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2 items-center">
          ...
          >
            <div className="space-y-2">
              ...
              <motion.h1
                className="text-3xl font-bold tracking-tighter sm:text-5xl md:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.3 }}
              >
                Service Microwave Panggilan Cepat & Terpercaya
              </motion.h1>
          ...
          >
            ...
            <div className="relative w-full max-w-md overflow-hidden rounded-3xl shadow-2xl">
              ...
              {/* Floating elements */}
              <motion.div
                className="absolute top-4 left-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm p-3 rounded-xl shadow-lg z-20"
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center">
                    <span className="text-blue-600 font-bold">1h</span>
                  </div>
                  <div>
                    <p className="text-sm font-medium">Respon Cepat</p>
                    <p className="text-xs text-gray-500">Dalam 1 jam</p>
                  </div>
                </div>
              </motion.div>

              <motion.div
                className="absolute bottom-4 right-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm p-3 rounded-xl shadow-lg z-20"
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Hingga 3 bulan</p>
                  </div>
                </div>
              </motion.div>
            </div>
