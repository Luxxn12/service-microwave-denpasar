      ...
      <div className="container px-4 md:px-6" ref={ref}>
        ...
        >
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Estimasi Biaya</h2>
        ...
        >
          {pricingItems.map((item, index) => (
            ...
            >
              ...
              <Card
                className={`flex flex-col h-full border-0 shadow-lg ${item.popular ? "shadow-blue-100 dark:shadow-blue-900/20" : ""}`}
              >
                <div className={`h-2 w-full bg-gradient-to-r ${item.color}`} />
                <CardHeader>
                  <CardTitle>{item.title}</CardTitle>
                  <CardDescription className="text-3xl font-bold mt-2">{item.price}</CardDescription>
                </CardHeader>
                ...
                <CardFooter>
                  <Button className={`w-full bg-gradient-to-r ${item.color} hover:opacity-90 text-white group`} asChild>
                    <a href="#kontak" className="flex items-center justify-center">
                      Hubungi Sekarang
