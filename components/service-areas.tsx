...
export default function ServiceAreas() {
  ...
  return (
    <section id="area" className="w-full py-12 md:py-24 lg:py-32 relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container px-4 md:px-6" ref={ref}>
        ...
        >
          <div className="space-y-2">
            ...
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Area Layanan</h2>
            ...
            <div className="relative">
              ...
              <div className="relative overflow-hidden rounded-3xl shadow-xl">
                ...
                <motion.div
                  ...
                  animate={{ y: [0, -10, 0] }}
                  transition={{ duration: 1.5, repeat: Number.POSITIVE_INFINITY, repeatType: "loop", delay: 0.5 }}
                >
                  <div className="w-6 h-6 bg-red-500 rounded-full flex items-center justify-center">
                    <MapPin className="h-4 w-4 text-white" />
                  </div>
                ...
                <motion.div
                  ...
                  animate={{ y: [0, -10, 0] }}
                  transition={{ duration: 1.5, repeat: Number.POSITIVE_INFINITY, repeatType: "loop", delay: 1 }}
                >
                  <div className="w-6 h-6 bg-red-500 rounded-full flex items-center justify-center">
                    <MapPin className="h-4 w-4 text-white" />
                  </div>
